from my_model.MultiTask import Multi_Task_2_Nocas
...
file_train = open(cp.get(section, 'acc_multi_MB_train_2_2_Nocas'), 'w')
file_valid = open(cp.get(section, 'acc_multi_MB_valid_2_2_Nocas'), 'w')
...
for i in range(0, epoch):
    ...
    if i%10 == 0:
        path = '/home/dell/Documents/Parameters/mul_task_mb_2_2_Nocas/'+'epoch_{}'.format(i) + '.pth'
