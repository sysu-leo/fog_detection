from my_model.MultiTask import Multi_Task_2_na
...
file_train = open(cp.get(section, 'acc_multi_MB_train_2_2_na'), 'w')
file_valid = open(cp.get(section, 'acc_multi_MB_valid_2_2_na'), 'w')
...
for i in range(0, epoch):
    ...
    if i%10 == 0:
        path = '/home/dell/Documents/Parameters/mul_task_mb_2_2_na/'+'epoch_{}'.format(i) + '.pth'
