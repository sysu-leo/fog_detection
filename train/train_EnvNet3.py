from my_model.EnvNet3 import EnvNet3
...
file = open(cp.get(section, 'acc_envnet3_train'), 'w')
file2 = open(cp.get(section, 'acc_envnet3_valid'), 'w')
...
#valid
    ...
    if i%5 == 0:
        path = '../Parameters/model_envnet3/'+'epoch{}'.format(i) + '.pth'
