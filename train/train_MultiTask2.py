from my_model.MultiTask import Multi_Task_2
...
file_train = open(cp.get(section, 'acc_multi_MB_train_2'), 'w')
file_valid = open(cp.get(section, 'acc_multi_MB_valid_2'), 'w')
...
for i in range(0, epoch):
    ...
    if i%10 == 0:
        path = '/home/dell/Documents/Parameters/mul_task_mb_2/'+'epoch_{}'.format(i) + '.pth'
