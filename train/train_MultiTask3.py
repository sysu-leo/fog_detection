from my_model.MultiTask import Multi_Task_3
...
file_train = open(cp.get(section, 'acc_multi_MB_train_3'), 'w')
file_valid = open(cp.get(section, 'acc_multi_MB_valid_3'), 'w')
...
for i in range(0, epoch):
    ...
    if i%10 == 0:
        path = '/home/dell/Documents/Parameters/mul_task_mb_3/'+'epoch_{}'.format(i) + '.pth'
