...
file = open(cp.get(section, 'acc_inception_res_train'), 'w')
file2 = open(cp.get(section, 'acc_inception_res_valid'), 'w')
...
for i in range(epoch):
    ...
    if i%5 == 0:
        path = '../Parameters/model_inception_res/'+'epoch{}'.format(i) + '.pth'
