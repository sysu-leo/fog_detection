...
file_train = open(cp.get(section, 'acc_alex_train'), 'w')
file_valid = open(cp.get(section, 'acc_alex_valid'), 'w')
...
for i in range(0, epoch):
    ...
    if i%10 == 0:
        path = '/home/dell/Documents/Parameters/AlexNet/'+'epoch_{}'.format(i) + '.pth'
