...
file = open(cp.get(section, 'acc_rgbd1_train'), 'w')
file2 = open(cp.get(section, 'acc_rgbd1_valid'), 'w')
...
#valid
    loss_val = 0.0
    correct_val = 0
    for inputs1, labels1 in valid_loader:
    ...
    if i%5 == 0:
        path = '../Parameters/model_rgbd1/'+'epoch{}'.format(i) + '.pth'
