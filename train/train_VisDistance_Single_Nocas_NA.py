from my_model.DisEstimation_Single_Nocas_NA import  DisEstimation_Single
...
file_train = open(cp.get(section, 'acc_vis_train_nocas_na'), 'w')
file_valid = open(cp.get(section, 'acc_vis_valid_nocas_na'), 'w')
...
for i in range(0, epoch):
    ...
    if i%10 == 0:
        path = '/home/dell/Documents/Parameters/vis_single_Nocas_na/'+'epoch_{}'.format(i) + '.pth'
