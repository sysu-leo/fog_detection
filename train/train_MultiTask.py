...
file_train = open(cp.get(section, 'acc_multi_MB_train'), 'w')
file_valid = open(cp.get(section, 'acc_multi_MB_valid'), 'w')
...
for i in range(0, epoch):
    ...
    if i%10 == 0:
        path = '/home/dell/Documents/Parameters/mul_task_mb/'+'epoch_{}'.format(i) + '.pth'
