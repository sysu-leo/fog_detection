...
file_train = open(cp.get(section, 'acc_vis_train_na'), 'w')
file_valid = open(cp.get(section, 'acc_vis_valid_na'), 'w')
...
for i in range(0, epoch):
    ...
    if i%10 == 0:
        path = '/home/dell/Documents/Parameters/vis_single_na/'+'epoch_{}'.format(i) + '.pth'
