...
file_train = open(cp.get(section, 'acc_inception_train'), 'w')
file_valid = open(cp.get(section, 'acc_inception_valid'), 'w')
...
for i in range(0, epoch):
    ...
    if i%10 == 0:
        path ='/home/dell/Documents/Parameters/model_inception/'+'epoch{}'.format(i) + '.pth'
