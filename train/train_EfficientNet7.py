...
file = open(cp.get(section, 'acc_efficient7_train'), 'w')
file2 = open(cp.get(section, 'acc_efficient7_valid'), 'w')
...
for i in range(epoch):
    ...
    del output, x, inputs1, labels1, labels, outputs,losses
    torch.cuda.empty_cache()

    if i%5 == 0:
        path = '../Parameters/model_efficient7/'+'epoch{}'.format(i) + '.pth'
