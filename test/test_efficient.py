...
# load weight
weight_path = '../Parameters/model_efficient{}/epoch{}.pth'.format(num, epoch)
model = EfficientNet.from_name('efficientnet-b{}'.format(num))
# model = Inceptionv4()
...
# train
correct = 0
res_path = '../test_result/efficient{}_epoch{}.txt'.format(num, epoch)
...
for img_name, x1,labels in test_loader:
    ...
    for i in range(32):
        try:
            ...
            print('error')
    del output, x1, labels, img_name, preds, prob
