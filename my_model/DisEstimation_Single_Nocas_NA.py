...
from my_model.TaskModule import FogLevel_Classify, VisDistance_Estimation, FogLevel_Classify_FC, Visibility_Estimation_FC_Nocas_na, VisDistance_Estimation_2
...
class DisEstimation_Single(nn.Module):
    def __init__(self):
        ...
        self.task2 = Visibility_Estimation_FC_Nocas_na()
